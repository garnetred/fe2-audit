const audit = {
  ...
  exerciseG() {
    ...
    restaurants.map(restaurant => delete restaurant.capacity)
    restaurants.map(restaurant => delete restaurant.cuisine)
    restaurants.map(restaurant => delete restaurant.popular_dishes)
  ...
  exerciseH() {
    ...
    const result =  restaurants.map(restaurant => restaurant.cuisine = restaurant.name);
